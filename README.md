...
| 프로젝트 | 기간 | 내용 |
| --- | --- | --- |
| **입찰 모니터링 모델 개발** | 2026.06&nbsp;–&nbsp;현재 | 행안부·NIA·조달청(주관) 데이터 분석 사업 · 진행 중 |
| **운수종사자 위험 예측 모델 개발** | 2025.12&nbsp;–&nbsp;2026.04 | 행안부·NIA·한국교통안전공단(주관) 데이터 분석 사업.<br>예측 모델과 서빙 API·관리 웹 개발, 쿠버네티스 기반 폐쇄망 클라우드 배포까지 전 구간 수행 |
