...
| 기간 | 업무 | 내용 |
| --- | --- | --- |
| 2025.12&nbsp;–&nbsp;현재 | 대회·해커톤 기획·운영 | 과제 설계와 대회용 데이터 구성, 참가자·리더보드 운영 |
| 2026.06&nbsp;–&nbsp;현재 | 입찰 모니터링 모델 개발 | 행안부·NIA·조달청 데이터 분석 사업. 과제 PL로 진행 중 |
| 2025.12&nbsp;–&nbsp;2026.04 | 운수종사자 위험 예측 플랫폼 개발 | 행안부·NIA·한국교통안전공단 위탁사업.<br>모델 학습·서빙·망분리 현장 배포까지 전 구간 수행 |
