...
![개발](https://img.shields.io/badge/%EA%B0%9C%EB%B0%9C-3D5A80)

| 기간 | 프로젝트 | 역할 | 내용 |
| --- | --- | --- | --- |
| 2026.06&nbsp;–&nbsp;현재 | 입찰 모니터링 모델 개발 | PL | 행안부·NIA·조달청 데이터 분석 사업.<br>진행 중 |
| 2025.12&nbsp;–&nbsp;2026.04 | 운수종사자 위험 예측 모델 개발 | PL | 행안부·NIA·한국교통안전공단 위탁사업.<br>예측 모델과 서빙 API·관리 웹·망분리 환경 배포까지 전 구간 수행 |

![기획·운영](https://img.shields.io/badge/%EA%B8%B0%ED%9A%8D%C2%B7%EC%9A%B4%EC%98%81-47725F)
...
![검증](https://img.shields.io/badge/%EA%B2%80%EC%A6%9D-5F5589)

| 프로젝트 | 내용 |
| --- | --- |
| KT 에이전트 신뢰성 검증 | 에이전트 검증 데이터셋 구축, 실성능 테스트, 화이트리스트 작성. KT와 공동 수행 |
