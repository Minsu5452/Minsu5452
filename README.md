...
> [!NOTE]
> 전체 프로젝트 16개의 배경·접근·결과와 기술 노트는 [**포트폴리오 사이트**](https://minsu5452.github.io)에 정리되어 있습니다.
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      운수종사자의 검사 결과와 사고 이력을 학습한 앙상블 모델로 사고 위험도를 예측하고, SHAP 해석과 함께 화면에서 조회·관리합니다.<br>예측 모델과 FastAPI 서빙, 관리 웹을 개발하고, 발주기관의 쿠버네티스 기반 폐쇄망 클라우드 환경에 실제 배포까지 수행했습니다.<br><br>
...
| 프로젝트 | 기간 | 주관기관 | 내용 |
| --- | --- | --- | --- |
| **입찰 모니터링 모델 개발** | 2026.06&nbsp;–&nbsp;현재 | 조달청 | 행안부·NIA AI기반 현안해결형 데이터 분석모델 개발 사업 · 진행 중 |
| **운수종사자 위험 예측 모델 개발** | 2025.12&nbsp;–&nbsp;2026.04 | 한국교통안전공단 | 행안부·NIA 정책 수립 지원 데이터 분석 사업.<br>예측 모델과 서빙 API·관리 웹 개발, 쿠버네티스 기반 폐쇄망 클라우드 배포까지 전 구간 수행 |
...
| 프로젝트 | 주관기관 | 내용 |
| --- | --- | --- |
| **해양사고 위험 예측 시스템** | 선박해양플랜트연구소 | 해양수산부 AI융복합 과제.<br>격자×시간 단위 데이터 설계, 위험 예측 모델 학습, SHAP 해석 |
| **해양 법령 도메인 RAG** | 해양정보기술 | 해양경찰청 CDX 과제.<br>법령 도메인 RAG DB 구축과 검색·답변 흐름 구성에 참여 |
...
| 2022.03 – 2022.06 | 머신러닝 | [백화점 고객 구매 이력 분류](https://github.com/Minsu5452/ml-department-store-classification) |
