...
| 개발 프로젝트 | 기간 | 역할 | 내용 |
| --- | --- | --- | --- |
| 입찰 모니터링 모델 개발 | 2026.06&nbsp;–&nbsp;현재 | PL | 행안부·NIA·조달청 데이터 분석 사업.<br>진행 중 |
| 운수종사자 위험 예측 모델 개발 | 2025.12&nbsp;–&nbsp;2026.04 | PL | 행안부·NIA·한국교통안전공단 위탁사업.<br>예측 모델과 서빙 API·관리 웹·망분리 환경 배포까지 전 구간 수행 |

| 기획·운영 | 기간 | 내용 |
| --- | --- | --- |
| AI 경진대회·해커톤 | 2025.12&nbsp;–&nbsp;현재 | 과제 설계, 대회용 데이터 구성, 참가자·리더보드 운영 |
