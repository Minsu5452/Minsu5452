...
> [!NOTE]
> 전체 프로젝트 20개의 배경·접근·결과는 **[포트폴리오 사이트](https://minsu5452.github.io)** 에서 한눈에 볼 수 있습니다.
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      운수종사자의 검사 결과와 사고 이력을 학습한 앙상블 모델로 사고 위험도를 예측하고, SHAP 해석과 함께 화면에서 조회·관리합니다. 예측 모델과 FastAPI 서빙, 관리 웹, 망분리 운영 환경에 맞춘 오프라인 배포 체계까지 전 구간을 개발했습니다.<br><br>
...
| 구분 | 기간 | 업무 | 내용 |
| --- | --- | --- | --- |
| ![개발](https://img.shields.io/badge/%EA%B0%9C%EB%B0%9C-2563EB) ![PL](https://img.shields.io/badge/PL-D97706) | 2026.06&nbsp;–&nbsp;현재 | 입찰 모니터링 모델 개발 | 행안부·NIA·조달청 데이터 분석 사업.<br>진행 중 |
| ![개발](https://img.shields.io/badge/%EA%B0%9C%EB%B0%9C-2563EB) ![PL](https://img.shields.io/badge/PL-D97706) | 2025.12&nbsp;–&nbsp;2026.04 | 운수종사자 위험 예측 모델 개발 | 행안부·NIA·한국교통안전공단 위탁사업.<br>예측 모델과 서빙 API·관리 웹·망분리 환경 배포까지 전 구간 수행 |
| ![기획·운영](https://img.shields.io/badge/%EA%B8%B0%ED%9A%8D%C2%B7%EC%9A%B4%EC%98%81-059669) | 2025.12&nbsp;–&nbsp;현재 | AI 경진대회·해커톤 | 과제 설계, 대회용 데이터 구성, 참가자·리더보드 운영 |
...
| 구분 | 프로젝트 | 내용 |
| --- | --- | --- |
| ![개발](https://img.shields.io/badge/%EA%B0%9C%EB%B0%9C-2563EB) | 해양사고 위험 예측 시스템 | 해양수산부 AI융복합 과제. 격자×시간 단위 데이터 설계, 위험 예측 모델 학습, SHAP 해석 |
| ![개발](https://img.shields.io/badge/%EA%B0%9C%EB%B0%9C-2563EB) | 해양 법령 도메인 RAG | 해양경찰청 CDX 과제. 법령 도메인 RAG DB 구축과 검색·답변 흐름 구성에 참여 |
| ![검증](https://img.shields.io/badge/%EA%B2%80%EC%A6%9D-7C3AED) | KT 에이전트 신뢰성 검증 | 에이전트 검증 데이터셋 구축, 실성능 테스트, 화이트리스트 작성. KT와 공동 수행 |
